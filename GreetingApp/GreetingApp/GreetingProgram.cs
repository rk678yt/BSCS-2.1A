...
namespace GreetingApp
{
    internal class GreetingProgram
    {
        static void Main(string[] args)
        {
            ...
            Console.Write("Enter the total number of your enrolled courses: "); //How many enrolled courses do you currently have?
            ...
            Console.WriteLine("Total enrolled courses: " + EnrolledCourses); //Your total courses are already inputted earlier so it's now displayed here
